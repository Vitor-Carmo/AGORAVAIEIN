...
<body class="bg-corFundo">
  ...
  <nav class="navbar navbar-light p-3 pl-5 " style="background-color: #E63946;">
    ...
    <div class="d-flex flex-column">
      <span class=" text-white"><strong>
          <font size="4px">Seja-Bem vindo :)</font>
        </strong></span>
      <button type="button" class="btn btn-outline-otoAzul p-1"><a href="cadastroCliente.php">Realize seu
          cadastro!</a></button>
    </div>
  </nav>
  ...
  <nav class=" navbar navbar-light d-flex justify-content-around  border border-testezin "
    ...
    <h5><a href='produtos.php'>Produtos</a></h5>
    <h5><a href="login.php"> Realizar login</a></h5>
